...
import 'controller_festival_detail.dart';

class FestivalDetailScreen extends StatelessWidget {
  FestivalDetailScreen({super.key, this.heading, this.desc, this.logo, this.id, });
  final dynamic id;
          ...
          children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                SizedBox(height: 16,),
                GetBuilder(init: ControllerFestivalDetail(id: id),
                      ...
                      SizedBox(height: controllerVariant.list.length>3 ?270:125,
                        child: GridView.builder(padding: EdgeInsets.only(left: 8),scrollDirection: Axis.horizontal,shrinkWrap: true,itemCount: controllerVariant.list.length,gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: controllerVariant.list.length>3 ?2:1,mainAxisExtent: 110,), itemBuilder: (itemBuilder,index){
                          return InkWell(onTap: (){
                            ...
                            Get.to(()=>SeeAllScreen(title: "${controllerVariant.list[index].name}", variantId: controllerVariant.list[index].id,));
                    ...
                    builder: (controllerBanner) {
                      return Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          CarouselWidget(controller: controllerBanner,),
                        ],
                      );
                    }
                ),
                    ...
                    builder: (controllerX) {
                      ...
                      Column(mainAxisSize: MainAxisSize.min,
                        children: [
                                ...
                                return
                                  Padding(
                                    ...
                                    child: InkWell(onTap: (){
                                      ...
                                      controllerVerticalDetail.variantId=controllerX.list[index].id!.toInt();
                          ...
                          controllerX.list.isEmpty?SizedBox():ItemWidgetVerticalDetail(variantId: controllerX.list.first.id,)
                        ],
                      );
                    }
                ),
